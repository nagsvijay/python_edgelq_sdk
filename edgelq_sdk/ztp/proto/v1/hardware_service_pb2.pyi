...
from edgelq_sdk.ztp.proto.v1 import hardware_change_pb2 as _hardware_change_pb2
...
class BatchGetHardwaresRequest(_message.Message):
...
class BatchGetHardwaresResponse(_message.Message):
    __slots__ = ("hardwares", "missing")
    HARDWARES_FIELD_NUMBER: _ClassVar[int]
    MISSING_FIELD_NUMBER: _ClassVar[int]
    hardwares: _containers.RepeatedCompositeFieldContainer[_hardware_pb2.Hardware]
    missing: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, hardwares: _Optional[_Iterable[_Union[_hardware_pb2.Hardware, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...

class ListHardwaresRequest(_message.Message):
...
class ListHardwaresResponse(_message.Message):
    __slots__ = ("hardwares", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    HARDWARES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, hardwares: _Optional[_Iterable[_Union[_hardware_pb2.Hardware, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchHardwareRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchHardwareResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _hardware_change_pb2.HardwareChange
    def __init__(self, change: _Optional[_Union[_hardware_change_pb2.HardwareChange, _Mapping]] = ...) -> None: ...

class WatchHardwaresRequest(_message.Message):
...
class WatchHardwaresResponse(_message.Message):
    __slots__ = ("hardware_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    HARDWARE_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    hardware_changes: _containers.RepeatedCompositeFieldContainer[_hardware_change_pb2.HardwareChange]
    is_current: bool
    page_token_change: WatchHardwaresResponse.PageTokenChange
    resume_token: str
    snapshot_size: int
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, hardware_changes: _Optional[_Iterable[_Union[_hardware_change_pb2.HardwareChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchHardwaresResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class CreateHardwareRequest(_message.Message):
    __slots__ = ("parent", "hardware")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    HARDWARE_FIELD_NUMBER: _ClassVar[int]
    parent: str
    hardware: _hardware_pb2.Hardware
    def __init__(self, parent: _Optional[str] = ..., hardware: _Optional[_Union[_hardware_pb2.Hardware, _Mapping]] = ...) -> None: ...

class UpdateHardwareRequest(_message.Message):
    __slots__ = ("hardware", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _hardware_pb2.Hardware
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_hardware_pb2.Hardware, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    HARDWARE_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateHardwareRequest.CAS
    allow_missing: bool
    def __init__(self, hardware: _Optional[_Union[_hardware_pb2.Hardware, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateHardwareRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
