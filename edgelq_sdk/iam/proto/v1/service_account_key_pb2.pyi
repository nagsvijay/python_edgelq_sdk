...
class ServiceAccountKey(_message.Message):
    __slots__ = ("name", "metadata", "display_name", "description", "public_key_data", "private_key_data", "api_key", "algorithm", "valid_not_before", "valid_not_after")
    ...
    def __init__(self, name: _Optional[str] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., public_key_data: _Optional[str] = ..., private_key_data: _Optional[str] = ..., api_key: _Optional[str] = ..., algorithm: _Optional[_Union[ServiceAccountKey.Algorithm, str]] = ..., valid_not_before: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., valid_not_after: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
