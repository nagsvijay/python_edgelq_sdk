...
class Project(_message.Message):
    __slots__ = ("name", "metadata", "title", "description", "parent_organization", "multi_region_policy", "enabled_services", "business_tier", "service_tiers", "root_organization", "ancestry_path", "service_errors", "services_generation")
