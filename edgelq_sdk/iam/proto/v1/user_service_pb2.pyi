...
from edgelq_sdk.iam.proto.v1 import user_change_pb2 as _user_change_pb2
...
class ListUsersResponse(_message.Message):
    __slots__ = ("users", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    USERS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, users: _Optional[_Iterable[_Union[_user_pb2.User, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchUserRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchUserResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _user_change_pb2.UserChange
    def __init__(self, change: _Optional[_Union[_user_change_pb2.UserChange, _Mapping]] = ...) -> None: ...
...
class WatchUsersResponse(_message.Message):
    __slots__ = ("user_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    USER_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    user_changes: _containers.RepeatedCompositeFieldContainer[_user_change_pb2.UserChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, user_changes: _Optional[_Iterable[_Union[_user_change_pb2.UserChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchUsersResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...
...
class UpdateUserRequest(_message.Message):
    __slots__ = ("user", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _user_pb2.User
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_user_pb2.User, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    USER_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateUserRequest.CAS
    allow_missing: bool
    def __init__(self, user: _Optional[_Union[_user_pb2.User, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateUserRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
