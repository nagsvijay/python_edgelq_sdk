...
from edgelq_sdk.iam.proto.v1 import role_change_pb2 as _role_change_pb2
...
class BatchGetRolesRequest(_message.Message):
...
class BatchGetRolesResponse(_message.Message):
    __slots__ = ("roles", "missing")
    ...
    def __init__(self, roles: _Optional[_Iterable[_Union[_role_pb2.Role, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListRolesResponse(_message.Message):
    __slots__ = ("roles", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    ROLES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, roles: _Optional[_Iterable[_Union[_role_pb2.Role, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchRoleRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchRoleResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _role_change_pb2.RoleChange
    def __init__(self, change: _Optional[_Union[_role_change_pb2.RoleChange, _Mapping]] = ...) -> None: ...

class WatchRolesRequest(_message.Message):
...
class WatchRolesResponse(_message.Message):
    __slots__ = ("role_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    ROLE_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    role_changes: _containers.RepeatedCompositeFieldContainer[_role_change_pb2.RoleChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, role_changes: _Optional[_Iterable[_Union[_role_change_pb2.RoleChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchRolesResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class CreateRoleRequest(_message.Message):
    __slots__ = ("parent", "role")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    ROLE_FIELD_NUMBER: _ClassVar[int]
    parent: str
    role: _role_pb2.Role
    def __init__(self, parent: _Optional[str] = ..., role: _Optional[_Union[_role_pb2.Role, _Mapping]] = ...) -> None: ...

class UpdateRoleRequest(_message.Message):
    __slots__ = ("role", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _role_pb2.Role
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_role_pb2.Role, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    ROLE_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateRoleRequest.CAS
    allow_missing: bool
    def __init__(self, role: _Optional[_Union[_role_pb2.Role, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateRoleRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
