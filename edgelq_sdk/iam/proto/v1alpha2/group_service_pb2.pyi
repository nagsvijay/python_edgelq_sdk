from edgelq_sdk.iam.proto.v1alpha2 import group_pb2 as _group_pb2
from edgelq_sdk.iam.proto.v1alpha2 import group_change_pb2 as _group_change_pb2
...
class BatchGetGroupsRequest(_message.Message):
...
class BatchGetGroupsResponse(_message.Message):
    __slots__ = ("groups", "missing")
    ...
    def __init__(self, groups: _Optional[_Iterable[_Union[_group_pb2.Group, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListGroupsResponse(_message.Message):
    __slots__ = ("groups", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    GROUPS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, groups: _Optional[_Iterable[_Union[_group_pb2.Group, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchGroupRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchGroupResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _group_change_pb2.GroupChange
    def __init__(self, change: _Optional[_Union[_group_change_pb2.GroupChange, _Mapping]] = ...) -> None: ...
...
class WatchGroupsResponse(_message.Message):
    __slots__ = ("group_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    GROUP_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    group_changes: _containers.RepeatedCompositeFieldContainer[_group_change_pb2.GroupChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, group_changes: _Optional[_Iterable[_Union[_group_change_pb2.GroupChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchGroupsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class CreateGroupRequest(_message.Message):
    __slots__ = ("parent", "group")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    GROUP_FIELD_NUMBER: _ClassVar[int]
    parent: str
    group: _group_pb2.Group
    def __init__(self, parent: _Optional[str] = ..., group: _Optional[_Union[_group_pb2.Group, _Mapping]] = ...) -> None: ...

class UpdateGroupRequest(_message.Message):
    __slots__ = ("group", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _group_pb2.Group
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_group_pb2.Group, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    GROUP_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateGroupRequest.CAS
    allow_missing: bool
    def __init__(self, group: _Optional[_Union[_group_pb2.Group, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateGroupRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
