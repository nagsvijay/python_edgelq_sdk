...
from edgelq_sdk.iam.proto.v1alpha2 import organization_invitation_change_pb2 as _organization_invitation_change_pb2
from edgelq_sdk.iam.proto.v1alpha2 import organization_invitation_custom_pb2 as _organization_invitation_custom_pb2
...
class BatchGetOrganizationInvitationsRequest(_message.Message):
...
class BatchGetOrganizationInvitationsResponse(_message.Message):
    __slots__ = ("organization_invitations", "missing")
    ...
    def __init__(self, organization_invitations: _Optional[_Iterable[_Union[_organization_invitation_pb2.OrganizationInvitation, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListOrganizationInvitationsResponse(_message.Message):
    __slots__ = ("organization_invitations", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    ORGANIZATION_INVITATIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, organization_invitations: _Optional[_Iterable[_Union[_organization_invitation_pb2.OrganizationInvitation, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchOrganizationInvitationRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchOrganizationInvitationResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _organization_invitation_change_pb2.OrganizationInvitationChange
    def __init__(self, change: _Optional[_Union[_organization_invitation_change_pb2.OrganizationInvitationChange, _Mapping]] = ...) -> None: ...

class WatchOrganizationInvitationsRequest(_message.Message):
...
class WatchOrganizationInvitationsResponse(_message.Message):
    __slots__ = ("organization_invitation_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    ORGANIZATION_INVITATION_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    organization_invitation_changes: _containers.RepeatedCompositeFieldContainer[_organization_invitation_change_pb2.OrganizationInvitationChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, organization_invitation_changes: _Optional[_Iterable[_Union[_organization_invitation_change_pb2.OrganizationInvitationChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchOrganizationInvitationsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class CreateOrganizationInvitationRequest(_message.Message):
    __slots__ = ("parent", "organization_invitation")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, parent: _Optional[str] = ..., organization_invitation: _Optional[_Union[_organization_invitation_pb2.OrganizationInvitation, _Mapping]] = ...) -> None: ...

class UpdateOrganizationInvitationRequest(_message.Message):
    __slots__ = ("organization_invitation", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _organization_invitation_pb2.OrganizationInvitation
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_organization_invitation_pb2.OrganizationInvitation, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    ORGANIZATION_INVITATION_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateOrganizationInvitationRequest.CAS
    allow_missing: bool
    def __init__(self, organization_invitation: _Optional[_Union[_organization_invitation_pb2.OrganizationInvitation, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateOrganizationInvitationRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
