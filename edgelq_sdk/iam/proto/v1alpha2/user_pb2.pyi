...
class User(_message.Message):
    __slots__ = ("name", "full_name", "metadata", "email", "email_verified", "auth_info", "settings", "refreshed_time")
    ...
    def __init__(self, name: _Optional[str] = ..., full_name: _Optional[str] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., email: _Optional[str] = ..., email_verified: bool = ..., auth_info: _Optional[_Union[User.AuthInfo, _Mapping]] = ..., settings: _Optional[_Mapping[str, str]] = ..., refreshed_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
