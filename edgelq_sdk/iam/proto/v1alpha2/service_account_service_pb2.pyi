...
from edgelq_sdk.iam.proto.v1alpha2 import service_account_change_pb2 as _service_account_change_pb2
...
class BatchGetServiceAccountsRequest(_message.Message):
...
class BatchGetServiceAccountsResponse(_message.Message):
    __slots__ = ("service_accounts", "missing")
    SERVICE_ACCOUNTS_FIELD_NUMBER: _ClassVar[int]
    MISSING_FIELD_NUMBER: _ClassVar[int]
    service_accounts: _containers.RepeatedCompositeFieldContainer[_service_account_pb2.ServiceAccount]
    missing: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, service_accounts: _Optional[_Iterable[_Union[_service_account_pb2.ServiceAccount, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListServiceAccountsResponse(_message.Message):
    __slots__ = ("service_accounts", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    SERVICE_ACCOUNTS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, service_accounts: _Optional[_Iterable[_Union[_service_account_pb2.ServiceAccount, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchServiceAccountRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchServiceAccountResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _service_account_change_pb2.ServiceAccountChange
    def __init__(self, change: _Optional[_Union[_service_account_change_pb2.ServiceAccountChange, _Mapping]] = ...) -> None: ...

class WatchServiceAccountsRequest(_message.Message):
...
class WatchServiceAccountsResponse(_message.Message):
    __slots__ = ("service_account_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    SERVICE_ACCOUNT_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    service_account_changes: _containers.RepeatedCompositeFieldContainer[_service_account_change_pb2.ServiceAccountChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, service_account_changes: _Optional[_Iterable[_Union[_service_account_change_pb2.ServiceAccountChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchServiceAccountsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class CreateServiceAccountRequest(_message.Message):
    __slots__ = ("parent", "service_account")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    SERVICE_ACCOUNT_FIELD_NUMBER: _ClassVar[int]
    parent: str
    service_account: _service_account_pb2.ServiceAccount
    def __init__(self, parent: _Optional[str] = ..., service_account: _Optional[_Union[_service_account_pb2.ServiceAccount, _Mapping]] = ...) -> None: ...

class UpdateServiceAccountRequest(_message.Message):
    __slots__ = ("service_account", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _service_account_pb2.ServiceAccount
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_service_account_pb2.ServiceAccount, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    SERVICE_ACCOUNT_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateServiceAccountRequest.CAS
    allow_missing: bool
    def __init__(self, service_account: _Optional[_Union[_service_account_pb2.ServiceAccount, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateServiceAccountRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
