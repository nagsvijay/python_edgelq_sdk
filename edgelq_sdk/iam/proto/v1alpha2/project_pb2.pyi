...
class Project(_message.Message):
    __slots__ = ("name", "title", "parent_organization", "root_organization", "ancestry_path", "metadata", "multi_region_policy", "enabled_services", "business_tier", "service_tiers", "service_errors")
    ...
    enabled_services: _containers.RepeatedScalarFieldContainer[str]
    ...
    def __init__(self, name: _Optional[str] = ..., title: _Optional[str] = ..., parent_organization: _Optional[str] = ..., root_organization: _Optional[str] = ..., ancestry_path: _Optional[_Iterable[str]] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., multi_region_policy: _Optional[_Union[_multi_region_policy_pb2.MultiRegionPolicy, _Mapping]] = ..., enabled_services: _Optional[_Iterable[str]] = ..., business_tier: _Optional[_Union[_common_pb2.BusinessTier, str]] = ..., service_tiers: _Optional[_Iterable[_Union[_common_pb2.ServiceBusinessTier, _Mapping]]] = ..., service_errors: _Optional[_Mapping[str, _common_pb2.ServiceErrors]] = ...) -> None: ...
