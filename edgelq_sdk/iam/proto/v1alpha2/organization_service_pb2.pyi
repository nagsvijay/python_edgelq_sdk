...
from edgelq_sdk.iam.proto.v1alpha2 import organization_change_pb2 as _organization_change_pb2
from edgelq_sdk.iam.proto.v1alpha2 import organization_custom_pb2 as _organization_custom_pb2
...
class BatchGetOrganizationsRequest(_message.Message):
...
class BatchGetOrganizationsResponse(_message.Message):
    __slots__ = ("organizations", "missing")
    ...
    def __init__(self, organizations: _Optional[_Iterable[_Union[_organization_pb2.Organization, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListOrganizationsResponse(_message.Message):
    __slots__ = ("organizations", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    ORGANIZATIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, organizations: _Optional[_Iterable[_Union[_organization_pb2.Organization, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchOrganizationRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchOrganizationResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _organization_change_pb2.OrganizationChange
    def __init__(self, change: _Optional[_Union[_organization_change_pb2.OrganizationChange, _Mapping]] = ...) -> None: ...

class WatchOrganizationsRequest(_message.Message):
...
class WatchOrganizationsResponse(_message.Message):
    __slots__ = ("organization_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    ORGANIZATION_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    organization_changes: _containers.RepeatedCompositeFieldContainer[_organization_change_pb2.OrganizationChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, organization_changes: _Optional[_Iterable[_Union[_organization_change_pb2.OrganizationChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchOrganizationsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...
...
class UpdateOrganizationRequest(_message.Message):
    __slots__ = ("organization", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _organization_pb2.Organization
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_organization_pb2.Organization, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    ORGANIZATION_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateOrganizationRequest.CAS
    allow_missing: bool
    def __init__(self, organization: _Optional[_Union[_organization_pb2.Organization, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateOrganizationRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
