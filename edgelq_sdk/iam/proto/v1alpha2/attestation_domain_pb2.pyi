...
class AttestationDomain(_message.Message):
    __slots__ = ("metadata", "name", "display_name", "insecure_skip_manufacturer_ekcert_verification", "policies", "enrollment_list")
    ...
    def __init__(self, metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., name: _Optional[str] = ..., display_name: _Optional[str] = ..., insecure_skip_manufacturer_ekcert_verification: bool = ..., policies: _Optional[_Iterable[_Union[AttestationDomain.Policy, _Mapping]]] = ..., enrollment_list: _Optional[_Iterable[_Union[AttestationDomain.EnrolledKey, _Mapping]]] = ...) -> None: ...
