...
from edgelq_sdk.iam.proto.v1alpha2 import condition_change_pb2 as _condition_change_pb2
...
class BatchGetConditionsRequest(_message.Message):
...
class BatchGetConditionsResponse(_message.Message):
    __slots__ = ("conditions", "missing")
    ...
    def __init__(self, conditions: _Optional[_Iterable[_Union[_condition_pb2.Condition, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListConditionsResponse(_message.Message):
    __slots__ = ("conditions", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    CONDITIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, conditions: _Optional[_Iterable[_Union[_condition_pb2.Condition, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchConditionRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchConditionResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _condition_change_pb2.ConditionChange
    def __init__(self, change: _Optional[_Union[_condition_change_pb2.ConditionChange, _Mapping]] = ...) -> None: ...

class WatchConditionsRequest(_message.Message):
...
class WatchConditionsResponse(_message.Message):
    __slots__ = ("condition_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    CONDITION_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    condition_changes: _containers.RepeatedCompositeFieldContainer[_condition_change_pb2.ConditionChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, condition_changes: _Optional[_Iterable[_Union[_condition_change_pb2.ConditionChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchConditionsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class CreateConditionRequest(_message.Message):
    __slots__ = ("parent", "condition")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    CONDITION_FIELD_NUMBER: _ClassVar[int]
    parent: str
    condition: _condition_pb2.Condition
    def __init__(self, parent: _Optional[str] = ..., condition: _Optional[_Union[_condition_pb2.Condition, _Mapping]] = ...) -> None: ...

class UpdateConditionRequest(_message.Message):
    __slots__ = ("condition", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _condition_pb2.Condition
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_condition_pb2.Condition, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    CONDITION_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateConditionRequest.CAS
    allow_missing: bool
    def __init__(self, condition: _Optional[_Union[_condition_pb2.Condition, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateConditionRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...

class DeleteConditionRequest(_message.Message):
    __slots__ = ("name",)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
