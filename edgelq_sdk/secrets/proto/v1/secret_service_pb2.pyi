from edgelq_sdk.secrets.proto.v1 import secret_pb2 as _secret_pb2
from edgelq_sdk.secrets.proto.v1 import secret_change_pb2 as _secret_change_pb2
...
class BatchGetSecretsRequest(_message.Message):
...
class BatchGetSecretsResponse(_message.Message):
    __slots__ = ("secrets", "missing")
    ...
    def __init__(self, secrets: _Optional[_Iterable[_Union[_secret_pb2.Secret, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListSecretsResponse(_message.Message):
    __slots__ = ("secrets", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    SECRETS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, secrets: _Optional[_Iterable[_Union[_secret_pb2.Secret, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchSecretRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchSecretResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _secret_change_pb2.SecretChange
    def __init__(self, change: _Optional[_Union[_secret_change_pb2.SecretChange, _Mapping]] = ...) -> None: ...

class WatchSecretsRequest(_message.Message):
...
class WatchSecretsResponse(_message.Message):
    __slots__ = ("secret_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    SECRET_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    secret_changes: _containers.RepeatedCompositeFieldContainer[_secret_change_pb2.SecretChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, secret_changes: _Optional[_Iterable[_Union[_secret_change_pb2.SecretChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchSecretsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...
...
class CreateSecretRequest(_message.Message):
    ...
    def __init__(self, parent: _Optional[str] = ..., secret: _Optional[_Union[_secret_pb2.Secret, _Mapping]] = ...) -> None: ...

class UpdateSecretRequest(_message.Message):
    __slots__ = ("secret", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _secret_pb2.Secret
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_secret_pb2.Secret, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    SECRET_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateSecretRequest.CAS
    allow_missing: bool
    def __init__(self, secret: _Optional[_Union[_secret_pb2.Secret, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateSecretRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
