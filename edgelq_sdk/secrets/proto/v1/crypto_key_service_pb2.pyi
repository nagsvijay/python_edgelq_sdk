...
from edgelq_sdk.secrets.proto.v1 import crypto_key_change_pb2 as _crypto_key_change_pb2
...
class BatchGetCryptoKeysRequest(_message.Message):
...
class BatchGetCryptoKeysResponse(_message.Message):
    __slots__ = ("crypto_keys", "missing")
    CRYPTO_KEYS_FIELD_NUMBER: _ClassVar[int]
    MISSING_FIELD_NUMBER: _ClassVar[int]
    crypto_keys: _containers.RepeatedCompositeFieldContainer[_crypto_key_pb2.CryptoKey]
    missing: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, crypto_keys: _Optional[_Iterable[_Union[_crypto_key_pb2.CryptoKey, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListCryptoKeysResponse(_message.Message):
    __slots__ = ("crypto_keys", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    CRYPTO_KEYS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, crypto_keys: _Optional[_Iterable[_Union[_crypto_key_pb2.CryptoKey, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchCryptoKeyRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchCryptoKeyResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _crypto_key_change_pb2.CryptoKeyChange
    def __init__(self, change: _Optional[_Union[_crypto_key_change_pb2.CryptoKeyChange, _Mapping]] = ...) -> None: ...

class WatchCryptoKeysRequest(_message.Message):
...
class WatchCryptoKeysResponse(_message.Message):
    __slots__ = ("crypto_key_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    CRYPTO_KEY_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    crypto_key_changes: _containers.RepeatedCompositeFieldContainer[_crypto_key_change_pb2.CryptoKeyChange]
    is_current: bool
    page_token_change: WatchCryptoKeysResponse.PageTokenChange
    resume_token: str
    snapshot_size: int
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, crypto_key_changes: _Optional[_Iterable[_Union[_crypto_key_change_pb2.CryptoKeyChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchCryptoKeysResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class DeleteCryptoKeyRequest(_message.Message):
    __slots__ = ("name",)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
