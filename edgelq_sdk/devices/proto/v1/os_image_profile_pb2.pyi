...
class OsImageProfile(_message.Message):
    __slots__ = ("name", "metadata", "display_name", "description", "device_type", "install_ai_accelerator", "encryption", "disk_mapping", "network_agent", "ntp", "http_proxy", "https_proxy", "no_proxy")
    ...
    https_proxy: str
    no_proxy: str
    def __init__(self, name: _Optional[str] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., device_type: _Optional[str] = ..., install_ai_accelerator: bool = ..., encryption: bool = ..., disk_mapping: _Optional[str] = ..., network_agent: _Optional[str] = ..., ntp: _Optional[str] = ..., http_proxy: _Optional[str] = ..., https_proxy: _Optional[str] = ..., no_proxy: _Optional[str] = ...) -> None: ...
