...
class ProvisioningApprovalRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., spec: _Optional[_Union[ProvisioningApprovalRequest.Spec, _Mapping]] = ..., status: _Optional[_Union[ProvisioningApprovalRequest.Status, _Mapping]] = ...) -> None: ...
