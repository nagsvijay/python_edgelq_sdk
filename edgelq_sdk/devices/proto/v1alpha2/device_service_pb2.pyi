...
from edgelq_sdk.devices.proto.v1alpha2 import device_custom_pb2 as _device_custom_pb2
...
class BatchGetDevicesRequest(_message.Message):
...
class BatchGetDevicesResponse(_message.Message):
    __slots__ = ("devices", "missing")
    ...
    def __init__(self, devices: _Optional[_Iterable[_Union[_device_pb2.Device, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListDevicesResponse(_message.Message):
    __slots__ = ("devices", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    DEVICES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, devices: _Optional[_Iterable[_Union[_device_pb2.Device, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchDeviceRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchDeviceResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _device_change_pb2.DeviceChange
    def __init__(self, change: _Optional[_Union[_device_change_pb2.DeviceChange, _Mapping]] = ...) -> None: ...

class WatchDevicesRequest(_message.Message):
...
class WatchDevicesResponse(_message.Message):
    __slots__ = ("device_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    DEVICE_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    device_changes: _containers.RepeatedCompositeFieldContainer[_device_change_pb2.DeviceChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, device_changes: _Optional[_Iterable[_Union[_device_change_pb2.DeviceChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchDevicesResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...
...
class CreateDeviceRequest(_message.Message):
    ...
    def __init__(self, parent: _Optional[str] = ..., device: _Optional[_Union[_device_pb2.Device, _Mapping]] = ...) -> None: ...

class UpdateDeviceRequest(_message.Message):
    __slots__ = ("device", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _device_pb2.Device
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_device_pb2.Device, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    DEVICE_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateDeviceRequest.CAS
    allow_missing: bool
    def __init__(self, device: _Optional[_Union[_device_pb2.Device, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateDeviceRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
