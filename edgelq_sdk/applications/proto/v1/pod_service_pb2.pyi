from edgelq_sdk.applications.proto.v1 import pod_pb2 as _pod_pb2
from edgelq_sdk.applications.proto.v1 import pod_change_pb2 as _pod_change_pb2
...
class BatchGetPodsRequest(_message.Message):
...
class BatchGetPodsResponse(_message.Message):
    __slots__ = ("pods", "missing")
    PODS_FIELD_NUMBER: _ClassVar[int]
    MISSING_FIELD_NUMBER: _ClassVar[int]
    pods: _containers.RepeatedCompositeFieldContainer[_pod_pb2.Pod]
    missing: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, pods: _Optional[_Iterable[_Union[_pod_pb2.Pod, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListPodsResponse(_message.Message):
    __slots__ = ("pods", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    PODS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, pods: _Optional[_Iterable[_Union[_pod_pb2.Pod, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchPodRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchPodResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _pod_change_pb2.PodChange
    def __init__(self, change: _Optional[_Union[_pod_change_pb2.PodChange, _Mapping]] = ...) -> None: ...

class WatchPodsRequest(_message.Message):
...
class WatchPodsResponse(_message.Message):
    __slots__ = ("pod_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    POD_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    pod_changes: _containers.RepeatedCompositeFieldContainer[_pod_change_pb2.PodChange]
    is_current: bool
    ...
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, pod_changes: _Optional[_Iterable[_Union[_pod_change_pb2.PodChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchPodsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class CreatePodRequest(_message.Message):
    __slots__ = ("parent", "pod")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    POD_FIELD_NUMBER: _ClassVar[int]
    parent: str
    pod: _pod_pb2.Pod
    def __init__(self, parent: _Optional[str] = ..., pod: _Optional[_Union[_pod_pb2.Pod, _Mapping]] = ...) -> None: ...

class UpdatePodRequest(_message.Message):
    __slots__ = ("pod", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _pod_pb2.Pod
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_pod_pb2.Pod, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    POD_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdatePodRequest.CAS
    allow_missing: bool
    def __init__(self, pod: _Optional[_Union[_pod_pb2.Pod, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdatePodRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...

class DeletePodRequest(_message.Message):
    __slots__ = ("name",)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
