from edgelq_sdk.applications.proto.v1 import common_pb2 as _common_pb2
...
class Pod(_message.Message):
    __slots__ = ("name", "metadata", "display_name", "description", "spec", "distribution", "status")
    class Status(_message.Message):
        __slots__ = ("phase", "container_statuses", "error", "failure_count")
        class Phase(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            IMAGE_DOWNLOAD_FAILED: _ClassVar[Pod.Status.Phase]
            INIT_FAILED: _ClassVar[Pod.Status.Phase]
            POD_CREATE_FAILED: _ClassVar[Pod.Status.Phase]
        ...
        IMAGE_DOWNLOAD_FAILED: Pod.Status.Phase
        INIT_FAILED: Pod.Status.Phase
        POD_CREATE_FAILED: Pod.Status.Phase
        ...
        error: str
        failure_count: int
        def __init__(self, phase: _Optional[_Union[Pod.Status.Phase, str]] = ..., container_statuses: _Optional[_Iterable[_Union[Pod.Status.Container, _Mapping]]] = ..., error: _Optional[str] = ..., failure_count: _Optional[int] = ...) -> None: ...
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    distribution: str
    status: Pod.Status
    def __init__(self, name: _Optional[str] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., spec: _Optional[_Union[_common_pb2.PodSpec, _Mapping]] = ..., distribution: _Optional[str] = ..., status: _Optional[_Union[Pod.Status, _Mapping]] = ...) -> None: ...
