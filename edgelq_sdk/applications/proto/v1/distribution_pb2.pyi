...
class Distribution(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., spec: _Optional[_Union[Distribution.Spec, _Mapping]] = ..., status: _Optional[_Union[Distribution.Status, _Mapping]] = ...) -> None: ...
