...
class MethodDescriptor(_message.Message):
    __slots__ = ("name", "display_name", "description", "labels", "promoted_label_key_sets", "versions", "metadata")
