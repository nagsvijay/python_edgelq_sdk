...
from edgelq_sdk.audit.proto.v1alpha2 import resource_change_log_pb2 as _resource_change_log_pb2
...
class SetResourceChangeLogsCommitStateRequest(_message.Message):
    __slots__ = ("log_keys", "timestamp", "tx_result")
    LOG_KEYS_FIELD_NUMBER: _ClassVar[int]
    TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, log_keys: _Optional[_Iterable[bytes]] = ..., timestamp: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., tx_result: _Optional[_Union[_resource_change_log_pb2.ResourceChangeLog.TransactionInfo.State, str]] = ...) -> None: ...
