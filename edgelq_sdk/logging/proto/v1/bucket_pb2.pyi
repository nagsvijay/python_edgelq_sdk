...
class Bucket(_message.Message):
    __slots__ = ("name", "metadata", "services", "versions", "logs", "required_alt_kvs")
    ...
    class RequiredTypedLabels(_message.Message):
        ...
        def __init__(self, descriptors: _Optional[_Iterable[str]] = ..., labels: _Optional[_Mapping[str, Bucket.RequiredTypedLabels.Strings]] = ...) -> None: ...
    ...
    logs: _containers.RepeatedCompositeFieldContainer[Bucket.RequiredTypedLabels]
    required_alt_kvs: _containers.RepeatedCompositeFieldContainer[Bucket.ResolvedKeysWithValues]
    def __init__(self, name: _Optional[str] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., services: _Optional[_Iterable[str]] = ..., versions: _Optional[_Iterable[str]] = ..., logs: _Optional[_Iterable[_Union[Bucket.RequiredTypedLabels, _Mapping]]] = ..., required_alt_kvs: _Optional[_Iterable[_Union[Bucket.ResolvedKeysWithValues, _Mapping]]] = ...) -> None: ...
