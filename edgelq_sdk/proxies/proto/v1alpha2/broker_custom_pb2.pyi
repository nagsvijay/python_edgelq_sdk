...
class ConnectRequest(_message.Message):
    ...
    class OpenRequest(_message.Message):
        __slots__ = ("project", "region_id", "name", "provider_name", "service", "arg")
        ...
        service: str
        arg: bytes
        def __init__(self, project: _Optional[str] = ..., region_id: _Optional[str] = ..., name: _Optional[str] = ..., provider_name: _Optional[str] = ..., service: _Optional[str] = ..., arg: _Optional[bytes] = ...) -> None: ...
    class ResumeRequest(_message.Message):
        __slots__ = ("project", "region_id", "name", "provider_name", "session_id", "channel_id", "last_message_id")
        PROJECT_FIELD_NUMBER: _ClassVar[int]
        REGION_ID_FIELD_NUMBER: _ClassVar[int]
        NAME_FIELD_NUMBER: _ClassVar[int]
        PROVIDER_NAME_FIELD_NUMBER: _ClassVar[int]
        ...
        channel_id: int
        last_message_id: int
        def __init__(self, project: _Optional[str] = ..., region_id: _Optional[str] = ..., name: _Optional[str] = ..., provider_name: _Optional[str] = ..., session_id: _Optional[int] = ..., channel_id: _Optional[int] = ..., last_message_id: _Optional[int] = ...) -> None: ...
...
class ListenRequest(_message.Message):
    ...
    class OpenRequest(_message.Message):
        __slots__ = ("project", "region_id", "name")
        PROJECT_FIELD_NUMBER: _ClassVar[int]
        REGION_ID_FIELD_NUMBER: _ClassVar[int]
        NAME_FIELD_NUMBER: _ClassVar[int]
        project: str
        region_id: str
        name: str
        def __init__(self, project: _Optional[str] = ..., region_id: _Optional[str] = ..., name: _Optional[str] = ...) -> None: ...
    class ResumeRequest(_message.Message):
        __slots__ = ("project", "region_id", "name", "session_id")
        PROJECT_FIELD_NUMBER: _ClassVar[int]
        REGION_ID_FIELD_NUMBER: _ClassVar[int]
        NAME_FIELD_NUMBER: _ClassVar[int]
        SESSION_ID_FIELD_NUMBER: _ClassVar[int]
        ...
        name: str
        session_id: int
        def __init__(self, project: _Optional[str] = ..., region_id: _Optional[str] = ..., name: _Optional[str] = ..., session_id: _Optional[int] = ...) -> None: ...
    class ChannelOpenError(_message.Message):
        __slots__ = ("channel_id", "message")
        CHANNEL_ID_FIELD_NUMBER: _ClassVar[int]
        MESSAGE_FIELD_NUMBER: _ClassVar[int]
...
class AcceptRequest(_message.Message):
    ...
    class OpenRequest(_message.Message):
        __slots__ = ("project", "region_id", "name", "session_id", "channel_id")
        PROJECT_FIELD_NUMBER: _ClassVar[int]
        REGION_ID_FIELD_NUMBER: _ClassVar[int]
        NAME_FIELD_NUMBER: _ClassVar[int]
        SESSION_ID_FIELD_NUMBER: _ClassVar[int]
        ...
        session_id: int
        channel_id: int
        def __init__(self, project: _Optional[str] = ..., region_id: _Optional[str] = ..., name: _Optional[str] = ..., session_id: _Optional[int] = ..., channel_id: _Optional[int] = ...) -> None: ...
    class ResumeRequest(_message.Message):
        __slots__ = ("project", "region_id", "name", "session_id", "channel_id", "last_message_id")
        PROJECT_FIELD_NUMBER: _ClassVar[int]
        REGION_ID_FIELD_NUMBER: _ClassVar[int]
        NAME_FIELD_NUMBER: _ClassVar[int]
        SESSION_ID_FIELD_NUMBER: _ClassVar[int]
        ...
        channel_id: int
        last_message_id: int
        def __init__(self, project: _Optional[str] = ..., region_id: _Optional[str] = ..., name: _Optional[str] = ..., session_id: _Optional[int] = ..., channel_id: _Optional[int] = ..., last_message_id: _Optional[int] = ...) -> None: ...
    OPEN_REQUEST_FIELD_NUMBER: _ClassVar[int]
    RESUME_REQUEST_FIELD_NUMBER: _ClassVar[int]
    DATA_FIELD_NUMBER: _ClassVar[int]
    ACK_FIELD_NUMBER: _ClassVar[int]
