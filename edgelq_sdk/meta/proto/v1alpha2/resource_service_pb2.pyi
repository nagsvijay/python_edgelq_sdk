...
from edgelq_sdk.meta.proto.v1alpha2 import resource_change_pb2 as _resource_change_pb2
...
class BatchGetResourcesResponse(_message.Message):
    ...
    def __init__(self, resources: _Optional[_Iterable[_Union[_resource_pb2.Resource, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListResourcesResponse(_message.Message):
    __slots__ = ("resources", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    RESOURCES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, resources: _Optional[_Iterable[_Union[_resource_pb2.Resource, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchResourceRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchResourceResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _resource_change_pb2.ResourceChange
    def __init__(self, change: _Optional[_Union[_resource_change_pb2.ResourceChange, _Mapping]] = ...) -> None: ...
...
class WatchResourcesResponse(_message.Message):
    __slots__ = ("resource_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    resource_changes: _containers.RepeatedCompositeFieldContainer[_resource_change_pb2.ResourceChange]
    is_current: bool
    page_token_change: WatchResourcesResponse.PageTokenChange
    resume_token: str
    snapshot_size: int
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, resource_changes: _Optional[_Iterable[_Union[_resource_change_pb2.ResourceChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchResourcesResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...
