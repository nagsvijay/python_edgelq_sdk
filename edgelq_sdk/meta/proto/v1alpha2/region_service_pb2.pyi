...
from edgelq_sdk.meta.proto.v1alpha2 import region_change_pb2 as _region_change_pb2
...
class BatchGetRegionsRequest(_message.Message):
...
class BatchGetRegionsResponse(_message.Message):
    __slots__ = ("regions", "missing")
    ...
    def __init__(self, regions: _Optional[_Iterable[_Union[_region_pb2.Region, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListRegionsResponse(_message.Message):
    __slots__ = ("regions", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    REGIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, regions: _Optional[_Iterable[_Union[_region_pb2.Region, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchRegionRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchRegionResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _region_change_pb2.RegionChange
    def __init__(self, change: _Optional[_Union[_region_change_pb2.RegionChange, _Mapping]] = ...) -> None: ...

class WatchRegionsRequest(_message.Message):
...
class WatchRegionsResponse(_message.Message):
    __slots__ = ("region_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    REGION_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    region_changes: _containers.RepeatedCompositeFieldContainer[_region_change_pb2.RegionChange]
    is_current: bool
    page_token_change: WatchRegionsResponse.PageTokenChange
    resume_token: str
    snapshot_size: int
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, region_changes: _Optional[_Iterable[_Union[_region_change_pb2.RegionChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchRegionsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...
