...
from edgelq_sdk.meta.proto.v1alpha2 import service_change_pb2 as _service_change_pb2
...
class BatchGetServicesResponse(_message.Message):
    ...
    def __init__(self, services: _Optional[_Iterable[_Union[_service_pb2.Service, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListServicesResponse(_message.Message):
    __slots__ = ("services", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    SERVICES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, services: _Optional[_Iterable[_Union[_service_pb2.Service, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...
...
class WatchServiceResponse(_message.Message):
    ...
    change: _service_change_pb2.ServiceChange
    def __init__(self, change: _Optional[_Union[_service_change_pb2.ServiceChange, _Mapping]] = ...) -> None: ...

class WatchServicesRequest(_message.Message):
...
class WatchServicesResponse(_message.Message):
    __slots__ = ("service_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    service_changes: _containers.RepeatedCompositeFieldContainer[_service_change_pb2.ServiceChange]
    is_current: bool
    page_token_change: WatchServicesResponse.PageTokenChange
    resume_token: str
    snapshot_size: int
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, service_changes: _Optional[_Iterable[_Union[_service_change_pb2.ServiceChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchServicesResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...
