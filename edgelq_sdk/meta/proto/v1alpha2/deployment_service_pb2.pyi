...
from edgelq_sdk.meta.proto.v1alpha2 import deployment_change_pb2 as _deployment_change_pb2
...
class BatchGetDeploymentsRequest(_message.Message):
...
class BatchGetDeploymentsResponse(_message.Message):
    __slots__ = ("deployments", "missing")
    ...
    def __init__(self, deployments: _Optional[_Iterable[_Union[_deployment_pb2.Deployment, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListDeploymentsResponse(_message.Message):
    __slots__ = ("deployments", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    DEPLOYMENTS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, deployments: _Optional[_Iterable[_Union[_deployment_pb2.Deployment, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchDeploymentRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchDeploymentResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _deployment_change_pb2.DeploymentChange
    def __init__(self, change: _Optional[_Union[_deployment_change_pb2.DeploymentChange, _Mapping]] = ...) -> None: ...

class WatchDeploymentsRequest(_message.Message):
...
class WatchDeploymentsResponse(_message.Message):
    __slots__ = ("deployment_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    DEPLOYMENT_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    deployment_changes: _containers.RepeatedCompositeFieldContainer[_deployment_change_pb2.DeploymentChange]
    is_current: bool
    page_token_change: WatchDeploymentsResponse.PageTokenChange
    resume_token: str
    snapshot_size: int
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, deployment_changes: _Optional[_Iterable[_Union[_deployment_change_pb2.DeploymentChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchDeploymentsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...
