...
class RecoveryStoreShardingInfo(_message.Message):
    __slots__ = ("name", "metadata", "validity_period", "spec")
    ...
    def __init__(self, name: _Optional[str] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., validity_period: _Optional[_Union[RecoveryStoreShardingInfo.ValidityPeriod, _Mapping]] = ..., spec: _Optional[_Union[RecoveryStoreShardingInfo.ShardingSpec, _Mapping]] = ...) -> None: ...
