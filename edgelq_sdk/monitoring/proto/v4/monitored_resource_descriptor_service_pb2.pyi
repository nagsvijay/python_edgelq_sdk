...
from edgelq_sdk.monitoring.proto.v4 import monitored_resource_descriptor_change_pb2 as _monitored_resource_descriptor_change_pb2
...
class CreateMonitoredResourceDescriptorRequest(_message.Message):
    __slots__ = ("parent", "monitored_resource_descriptor")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, parent: _Optional[str] = ..., monitored_resource_descriptor: _Optional[_Union[_monitored_resource_descriptor_pb2.MonitoredResourceDescriptor, _Mapping]] = ...) -> None: ...
