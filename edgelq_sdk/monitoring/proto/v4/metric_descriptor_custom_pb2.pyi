...
from edgelq_sdk.monitoring.proto.v4 import metric_descriptor_change_pb2 as _metric_descriptor_change_pb2
...
class ListMetricDescriptorsResponse(_message.Message):
    __slots__ = ("metric_descriptors", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    ...
    def __init__(self, metric_descriptors: _Optional[_Iterable[_Union[_metric_descriptor_pb2.MetricDescriptor, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...
