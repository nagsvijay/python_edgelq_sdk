...
from edgelq_sdk.monitoring.proto.v4 import bucket_change_pb2 as _bucket_change_pb2
...
class BatchGetBucketsRequest(_message.Message):
...
class BatchGetBucketsResponse(_message.Message):
    __slots__ = ("buckets", "missing")
    BUCKETS_FIELD_NUMBER: _ClassVar[int]
    MISSING_FIELD_NUMBER: _ClassVar[int]
    buckets: _containers.RepeatedCompositeFieldContainer[_bucket_pb2.Bucket]
    missing: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, buckets: _Optional[_Iterable[_Union[_bucket_pb2.Bucket, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListBucketsResponse(_message.Message):
    __slots__ = ("buckets", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    BUCKETS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, buckets: _Optional[_Iterable[_Union[_bucket_pb2.Bucket, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchBucketRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchBucketResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _bucket_change_pb2.BucketChange
    def __init__(self, change: _Optional[_Union[_bucket_change_pb2.BucketChange, _Mapping]] = ...) -> None: ...

class WatchBucketsRequest(_message.Message):
...
class WatchBucketsResponse(_message.Message):
    __slots__ = ("bucket_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    BUCKET_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    bucket_changes: _containers.RepeatedCompositeFieldContainer[_bucket_change_pb2.BucketChange]
    is_current: bool
    page_token_change: WatchBucketsResponse.PageTokenChange
    resume_token: str
    snapshot_size: int
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, bucket_changes: _Optional[_Iterable[_Union[_bucket_change_pb2.BucketChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchBucketsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class CreateBucketRequest(_message.Message):
    __slots__ = ("parent", "bucket")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    BUCKET_FIELD_NUMBER: _ClassVar[int]
    parent: str
    bucket: _bucket_pb2.Bucket
    def __init__(self, parent: _Optional[str] = ..., bucket: _Optional[_Union[_bucket_pb2.Bucket, _Mapping]] = ...) -> None: ...

class UpdateBucketRequest(_message.Message):
    __slots__ = ("bucket", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _bucket_pb2.Bucket
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_bucket_pb2.Bucket, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    BUCKET_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateBucketRequest.CAS
    allow_missing: bool
    def __init__(self, bucket: _Optional[_Union[_bucket_pb2.Bucket, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateBucketRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
