...
class PhantomTimeSerie(_message.Message):
    __slots__ = ("name", "metadata", "key", "project", "metric", "resource", "metric_kind", "value_type", "value")
    ...
    def __init__(self, name: _Optional[str] = ..., metadata: _Optional[_Union[_meta_pb2.Meta, _Mapping]] = ..., key: _Optional[bytes] = ..., project: _Optional[str] = ..., metric: _Optional[_Union[_common_pb2.Metric, _Mapping]] = ..., resource: _Optional[_Union[_common_pb2.MonitoredResource, _Mapping]] = ..., metric_kind: _Optional[_Union[_metric_descriptor_pb2.MetricDescriptor.MetricKind, str]] = ..., value_type: _Optional[_Union[_metric_descriptor_pb2.MetricDescriptor.ValueType, str]] = ..., value: _Optional[_Union[_common_pb2.TypedValue, _Mapping]] = ...) -> None: ...
