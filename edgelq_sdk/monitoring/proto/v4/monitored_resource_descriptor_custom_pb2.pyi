...
class ListMonitoredResourceDescriptorsResponse(_message.Message):
    __slots__ = ("monitored_resource_descriptors", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    ...
    def __init__(self, monitored_resource_descriptors: _Optional[_Iterable[_Union[_monitored_resource_descriptor_pb2.MonitoredResourceDescriptor, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...
