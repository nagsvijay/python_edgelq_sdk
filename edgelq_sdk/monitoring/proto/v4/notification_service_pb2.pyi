...
from edgelq_sdk.monitoring.proto.v4 import notification_change_pb2 as _notification_change_pb2
...
class BatchGetNotificationsRequest(_message.Message):
...
class BatchGetNotificationsResponse(_message.Message):
    __slots__ = ("notifications", "missing")
    ...
    def __init__(self, notifications: _Optional[_Iterable[_Union[_notification_pb2.Notification, _Mapping]]] = ..., missing: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ListNotificationsResponse(_message.Message):
    __slots__ = ("notifications", "prev_page_token", "next_page_token", "current_offset", "total_results_count")
    NOTIFICATIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, notifications: _Optional[_Iterable[_Union[_notification_pb2.Notification, _Mapping]]] = ..., prev_page_token: _Optional[str] = ..., next_page_token: _Optional[str] = ..., current_offset: _Optional[int] = ..., total_results_count: _Optional[int] = ...) -> None: ...

class WatchNotificationRequest(_message.Message):
    __slots__ = ("name", "field_mask", "view")
    NAME_FIELD_NUMBER: _ClassVar[int]
    FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
    VIEW_FIELD_NUMBER: _ClassVar[int]
...
class WatchNotificationResponse(_message.Message):
    __slots__ = ("change",)
    CHANGE_FIELD_NUMBER: _ClassVar[int]
    change: _notification_change_pb2.NotificationChange
    def __init__(self, change: _Optional[_Union[_notification_change_pb2.NotificationChange, _Mapping]] = ...) -> None: ...
...
class WatchNotificationsResponse(_message.Message):
    __slots__ = ("notification_changes", "is_current", "page_token_change", "resume_token", "snapshot_size", "is_soft_reset", "is_hard_reset")
    ...
    NOTIFICATION_CHANGES_FIELD_NUMBER: _ClassVar[int]
    ...
    notification_changes: _containers.RepeatedCompositeFieldContainer[_notification_change_pb2.NotificationChange]
    is_current: bool
    page_token_change: WatchNotificationsResponse.PageTokenChange
    resume_token: str
    snapshot_size: int
    is_soft_reset: bool
    is_hard_reset: bool
    def __init__(self, notification_changes: _Optional[_Iterable[_Union[_notification_change_pb2.NotificationChange, _Mapping]]] = ..., is_current: bool = ..., page_token_change: _Optional[_Union[WatchNotificationsResponse.PageTokenChange, _Mapping]] = ..., resume_token: _Optional[str] = ..., snapshot_size: _Optional[int] = ..., is_soft_reset: bool = ..., is_hard_reset: bool = ...) -> None: ...

class CreateNotificationRequest(_message.Message):
    __slots__ = ("parent", "notification")
    PARENT_FIELD_NUMBER: _ClassVar[int]
    NOTIFICATION_FIELD_NUMBER: _ClassVar[int]
    parent: str
    notification: _notification_pb2.Notification
    def __init__(self, parent: _Optional[str] = ..., notification: _Optional[_Union[_notification_pb2.Notification, _Mapping]] = ...) -> None: ...

class UpdateNotificationRequest(_message.Message):
    __slots__ = ("notification", "update_mask", "cas", "allow_missing")
    class CAS(_message.Message):
        __slots__ = ("conditional_state", "field_mask")
        CONDITIONAL_STATE_FIELD_NUMBER: _ClassVar[int]
        FIELD_MASK_FIELD_NUMBER: _ClassVar[int]
        conditional_state: _notification_pb2.Notification
        field_mask: _field_mask_pb2.FieldMask
        def __init__(self, conditional_state: _Optional[_Union[_notification_pb2.Notification, _Mapping]] = ..., field_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ...) -> None: ...
    NOTIFICATION_FIELD_NUMBER: _ClassVar[int]
    ...
    cas: UpdateNotificationRequest.CAS
    allow_missing: bool
    def __init__(self, notification: _Optional[_Union[_notification_pb2.Notification, _Mapping]] = ..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]] = ..., cas: _Optional[_Union[UpdateNotificationRequest.CAS, _Mapping]] = ..., allow_missing: bool = ...) -> None: ...
