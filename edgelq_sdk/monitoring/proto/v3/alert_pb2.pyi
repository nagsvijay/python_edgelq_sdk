...
class Alert(_message.Message):
    ...
    class Info(_message.Message):
        ...
        class TimeSerie(_message.Message):
            __slots__ = ("key", "metric", "monitored_resource")
            ...
            def __init__(self, key: _Optional[bytes] = ..., metric: _Optional[_Union[_common_pb2.Metric, _Mapping]] = ..., monitored_resource: _Optional[_Union[_common_pb2.MonitoredResource, _Mapping]] = ...) -> None: ...
    ...
    class State(_message.Message):
        ...
        class Threshold(_message.Message):
            __slots__ = ("observed_value",)
            OBSERVED_VALUE_FIELD_NUMBER: _ClassVar[int]
            observed_value: float
            def __init__(self, observed_value: _Optional[float] = ...) -> None: ...
        class CombineThreshold(_message.Message):
            __slots__ = ()
            class PerMetric(_message.Message):
                __slots__ = ("observed_values",)
                class ObservedValuesEntry(_message.Message):
                    __slots__ = ("key", "value")
                    KEY_FIELD_NUMBER: _ClassVar[int]
                    VALUE_FIELD_NUMBER: _ClassVar[int]
                    key: str
                    ...
                    def __init__(self, key: _Optional[str] = ..., value: _Optional[float] = ...) -> None: ...
                OBSERVED_VALUES_FIELD_NUMBER: _ClassVar[int]
                observed_values: _containers.ScalarMap[str, float]
                def __init__(self, observed_values: _Optional[_Mapping[str, float]] = ...) -> None: ...
